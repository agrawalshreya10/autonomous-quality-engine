...
class OllamaClient(LLMClient):
    ...
    def _build_prompt(
        ...
        if screenshot_path:
            parts.append(f"A screenshot was saved at: {screenshot_path} (you cannot see it; suggest based on typical UI issues).")
        parts.append(
            "Respond with two short sections: **Probable cause** and **Suggested fix** (code or steps). Use markdown."
        )
        return "\n\n".join(parts)
